      ...
      <div className="container 2xl:px-20 px-2  xl:px-6  mx-auto pb-10 text-black py-10">
        ...
        <div className="py-10">
          <div>
            ...
            <div className="my-10">
              <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12">{t("section2.1.17")}</div>
            ...
            <div className="grid grid-cols-12 gap-4 mt-10 mb-20">
              <div className="col-span-12">{t("section2.1.19")}</div>
              <div className="col-span-4">
                <img
            ...
            <div className="whMapRow">
              <div className="grid grid-cols-12 gap-4">
                ...
                <div className="col-span-12 md:col-span-6 xl:col-span-5">
                  <div className="whMap">
                    <div className="bg-[#EA8001] relative p-1">
                      <img
                      ...
                      />
                      <button
                        className="absolute top-[20%] left-[35%] hover:scale-150 transition-all hover:text-orange-500 text-red-500"
                        onClick={() => setLocation(1)}
                      >
                        <IoPin size={30} />
                      </button>
                      <button
                        className="absolute top-[51%] left-[55%] hover:scale-150 transition-all hover:text-orange-500 text-red-500"
                        onClick={() => setLocation(2)}
                      >
                        <IoPin size={30} />
                      </button>
                      <button
                        className="absolute top-[48%] left-[58%] hover:scale-150 transition-all hover:text-orange-500 text-red-500"
                        onClick={() => setLocation(3)}
                      >
                        <IoPin size={30} />
                      </button>
                      <button
                        className="absolute top-[24%] left-[80%] hover:scale-150 transition-all hover:text-orange-500 text-red-500"
                        onClick={() => setLocation(4)}
                      >
                        <IoPin size={30} />
                      </button>
                      <button
                        className="absolute top-[82%] left-[50%] hover:scale-150 transition-all hover:text-orange-500 text-red-500"
                        onClick={() => setLocation(5)}
                      >
                        <IoPin size={30} />
                      </button>
                      <button
                        className="absolute top-[2%] left-[8%] hover:scale-150 transition-all hover:text-orange-500 text-red-500"
                        onClick={() => setLocation(6)}
                      >
                        <IoPin size={30} />
                      </button>
                      <button
                        className="absolute top-[53%] left-[60%] hover:scale-150 transition-all hover:text-orange-500 text-red-500"
                  ...
                  <div className="tab-content">
                    {location == 1 && (
                      <div className=" active in" id="whMap1">
                        ...
                        <Image
                          src="/img/service/warehouse/008.jpg"
                          height={400}
                          width={400}
                          alt="warehouse"
                          className="w-full"
                    ...
                    {location == 2 && (
                      <div className="" id="whMap2">
                        ...
                        <div className="whText3" style={{ whiteSpace: "pre" }}>
                          {t("section2.address.2.addr")}
                        </div>
                        <Image
                          src="/img/service/warehouse/009.jpg"
                          height={400}
                          width={400}
                          alt="warehouse"
                          className="w-full"
                    ...
                    {location == 3 && (
                      <div className="" id="whMap3">
                        ...
                        <div className="whText3" style={{ whiteSpace: "pre" }}>
                          {t("section2.address.3.addr")}
                        </div>
                        <Image
                          src="/img/service/warehouse/010.jpg"
                          height={400}
                          width={400}
                          alt="warehouse"
                          className="w-full"
                    ...
                    {location == 4 && (
                      <div className="" id="whMap4">
                        ...
                        <div className="whText3" style={{ whiteSpace: "pre" }}>
                          {t("section2.address.4.addr")}
                        </div>
                        <Image
                          src="/img/service/warehouse/011.jpg"
                          height={400}
                          width={400}
                          alt="warehouse"
                          className="w-full"
                    ...
                    {location == 5 && (
                      <div className="" id="whMap6">
                        ...
                        <div className="whText3" style={{ whiteSpace: "pre" }}>
                          {t("section2.address.5.addr")}
                        </div>
                        <Image
                          src="/img/service/warehouse/013.jpg"
                          height={400}
                          width={400}
                          alt="warehouse"
                          className="w-full"
                    ...
                    {location == 6 && (
                      <div className="" id="whMap7">
                        ...
                        <div className="whText3" style={{ whiteSpace: "pre" }}>
                          {t("section2.address.6.addr")}
                        </div>
                        <Image
                          src="/img/service/warehouse/015.jpg"
                          height={400}
                          width={400}
                          alt="warehouse"
                          className="w-full"
                    ...
                    {location == 7 && (
                      <div>
                        ...
                        <div className="whText3" style={{ whiteSpace: "pre" }}>
                          {t("section2.address.7.addr")}
                        </div>
                        <Image
                          src="/img/service/warehouse/021.jpg"
                          height={400}
                          width={400}
                          alt="warehouse"
                          className="w-full"
