  ...
  return (
    <>
      <Cover
        ...
        image="/img/service/customs-clearance/banner.jpg"
      />
          ...
          <div className="cusCleRow4">
            <div className="grid grid-cols-12 gap-4">
              <div className="col-span-12 md:col-span-9 relative">
                ...
                <div className="hidden md:block absolute bottom-0 right-0 underline">
                  {t("section1.feature.img-title")}
                </div>
              </div>
            ...
            <div className="col-span-12 flex justify-center mt-10">
              <div className="relative z-20">
                ...
                <div className="absolute top-1 ms-34 md:ms-80 z-100">
                  <h5 className="text-[#1c2f50] text-sm md:text-2xl md:my-2 md:text-normal">
                    ● {t("section2.1.1")}
                  </h5>
                  <h5 className="text-[#1c2f50] text-sm md:text-2xl md:my-2 md:text-normal">
                    ● {t("section2.1.2")}
          ...
          <div className="cusCleRow3">
            <div className="grid grid-cols-12 gap-6 mt-10">
              ...
              <div className="col-span-12 md:col-span-4">
                <div className="cusCleRow3Title">
                  {t("section2.3.export.title")}
                </div>
