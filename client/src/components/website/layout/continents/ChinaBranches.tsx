  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="branchesText font-jpNoto">
          江蘇省常熟市黄河路22号 匯豊時代広場1棟606
          <br />
          TEL : 86-512-5192-7026 / FAX : 86-512-5288-5729
        </div>
        ...
        <div className="branchesText font-jpNoto">
          ...
          <br />
          TEL : 86-21-5866-0700 / FAX : 86-21-5866-4101
        </div>
