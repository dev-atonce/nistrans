  ...
  return (
    <div className="container  px-2 mx-auto 2xl:px-20 pb-10 text-black">
      <p className="branchesTopic no-padding-r">
        ...
        เราเป็นผู้บุกเบิกการขนส่งและกระจายสินค้าแบบครบวงจรระดับสากลของไทย
        ซึ่งครอบคลุมตั้งแต่การขนส่งระหว่างประเทศและภายในประเทศทั้งทางบก ทางทะเล
        และทางอากาศ คลังสินค้าและบรรจุภัณฑ์เพื่อการส่งออก ตลอดจนงานขนย้าย
        เราดำเนินพิธีการศุลกากรเองตั้งแต่แรกก่อตั้ง ด้วยระบบ paper less
        มีการปรับเป็นระบบออนไลน์โดยใช้ EDI
        กับด่านศุลกากรในหน่วยงานพิธีการศุลกากรทั้งหมด นอกจากนี้
        ยังมีสาขาย่อยที่แหลมฉบัง พระนครศรีอยุธยา บางปะกง ปราจีนบุรี และเชียงใหม่
        ให้บริการแบบเชื่อมโยง ระหว่างกันทั่วโลกในฐานะ Global Logistics Service
        Provider โดยถือคติในการให้บริการอย่างพิถีพิถัน
        ด้วยพนักงานที่มากประสบการณ์
        เพื่อให้สามารถติดต่อลูกค้าได้อย่างใกล้ชิดพร้อมรองรับความต้องการทุกรูปแบบ
      </p>
      <div>
