...
export default function FormUser({
  ...
  const { role, id: userId } = useUsersStore();
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            <span className="mb-1.5 block font-medium">
              {type === "create" ? "Create New Account" : "Edit Account"}
            </span>
            ...
            <form
              onSubmit={handleSubmitForm(type === "create" ? onCreate : onEdit)}
            >
              <div className="mb-4">
                <div className="mb-4.5">
                  ...
                  <div className="relative z-20 bg-transparent dark:bg-form-input">
                    <select
                      ...
                      onChange={setData}
                      className={`relative z-20 w-full appearance-none rounded border hover:cursor-pointer border-stroke bg-transparent px-5 py-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${
                ...
                <div className="relative">
                  <input
                    ...
                    value={edit ? itemState?.username : undefined}
                    onChange={setData}
                    type="text"
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={setData}
                    value={edit ? itemState?.email : undefined}
                    type="email"
              ...
              <div className="mb-4">
                <label className="mb-2.5 block font-medium text-black dark:text-white">
                  Password {edit && "(For Changing Password Only)"}
                </label>
                <div className="relative">
                  <input
                    type="password"
              ...
              <div className="mb-6">
                <label className="mb-2.5 block font-medium text-black dark:text-white">
                  Re-type Password {edit && "(For Changing Password Only)"}
                </label>
                <div className="relative">
                  <input
                    // @ts-ignore
              ...
              <div className="mb-5">
                <input
                  type="submit"
                  value={create ? "Create account" : "Edit Account"}
